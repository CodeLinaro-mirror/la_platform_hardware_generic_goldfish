...
* **Bazel plugin:** The bazel plugin currently uses the location of the WORKSPACE file to derive targets, like `@goldfish//...`, without a WORKSPACE file they will be incorrectly derived. We no longer use WORKSPACE files as we have switched to bazel modules. As a workaround you can create an empty one yourself in $AOSP.
