...
class IniFile {
  ...
  public:
    ...
    //   default value.
    std::string getString(const std::string& key, std::string_view defaultValue) const;
    ...
    DiskSize getDiskSize(const std::string& key, std::string_view defaultValue) const;
