...
//     derror(
//         "ERROR: trying to run on main looper "
...
// static
// void ThreadLooper::runOnMainLooperAndWaitForCompletion(
//     ThreadLooper::Closure&& func) {
//   if (!android_getMainLooper()) {
...
// static
// void ThreadLooper::clearMainRunner() { sMainRunner.clear(); }
