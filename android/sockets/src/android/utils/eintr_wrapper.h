    ...
    __extension__({                                                                       \
        ...
        for (;;) {                                                                        \
            ...
            if (++eintr_wrapper_loop_count >= MAX_EINTR_LOOP_COUNT) {                     \
                android_eintr_wrapper_fatal(__FILE__, __LINE__, __PRETTY_FUNCTION__, #x); \
            }                                                                             \
        };                                                                                \
        eintr_wrapper_result;                                                             \
    })
...
void __attribute__((noreturn)) android_eintr_wrapper_fatal(const char* file, long lineno,
