...
bool dcheckIsEnabled() { return gDcheckLevel; }
...
extern "C" LogSeverity getMinLogLevel() { return gMinLogLevel; }
...
LogstreamBuf::LogstreamBuf() { setp(mStr, mStr + sizeof(mStr)); }

size_t LogstreamBuf::size() { return this->pptr() - this->pbase(); }
