...
TEST_F(AbseilLogCBridgeTest, InfoLog) {
    ...
    EXPECT_EQ(log_sink_->captured_log_,
              absl::StrFormat("I abseil_log_bridge_test.cc:%d - This is a INFO message", line));
}
...
TEST_F(AbseilLogCBridgeTest, ErrorLog) {
    ...
    auto line = __LINE__ - 1;
    EXPECT_EQ(log_sink_->captured_log_,
              absl::StrFormat("E abseil_log_bridge_test.cc:%d - This is a ERROR message", line));
}
...
TEST_F(AbseilLogCBridgeTest, WarningLog) {
    ...
    auto line = __LINE__ - 1;
    EXPECT_EQ(log_sink_->captured_log_,
              absl::StrFormat("W abseil_log_bridge_test.cc:%d - This is a WARNING message", line));
}
...
TEST_F(AbseilLogCBridgeTest, VLOG1) {
    ...
    auto line = __LINE__ - 1;
    EXPECT_EQ(log_sink_->captured_log_,
              absl::StrFormat("I abseil_log_bridge_test.cc:%d - This is a VLOG(1) message", line));
}
...
TEST_F(AbseilLogCBridgeTest, VLOG2) {
    ...
    auto line = __LINE__ - 1;
    EXPECT_EQ(log_sink_->captured_log_,
              absl::StrFormat("I abseil_log_bridge_test.cc:%d - This is a VLOG(2) message", line));
}
...
TEST_F(AbseilLogCBridgeTest, CInfoLog) {
    ...
    EXPECT_EQ(log_sink_->captured_log_, "I abseil_log_bridge_test.c:17 - This is a C INFO message");
}

TEST_F(AbseilLogCBridgeTest, CErrorLog) {
    test_c_error_log("This is a C ERROR message");
    EXPECT_EQ(log_sink_->captured_log_,
              "E abseil_log_bridge_test.c:21 - This is a C ERROR message");
}

TEST_F(AbseilLogCBridgeTest, CWarningLog) {
    test_c_warning_log("This is a C WARNING message");
    EXPECT_EQ(log_sink_->captured_log_,
              "W abseil_log_bridge_test.c:25 - This is a C WARNING message");
}

TEST_F(AbseilLogCBridgeTest, CVLOG1) {
    test_c_vlog1("This is a C VLOG(1) message");
    EXPECT_EQ(log_sink_->captured_log_,
              "I abseil_log_bridge_test.c:29 - This is a C VLOG(1) message");
}

TEST_F(AbseilLogCBridgeTest, CVLOG2) {
    test_c_vlog2("This is a C VLOG(2) message");
    EXPECT_EQ(log_sink_->captured_log_,
              "I abseil_log_bridge_test.c:33 - This is a C VLOG(2) message");
}
...
TEST_F(AbseilLogCBridgeTest, CVLOG1_File2) {
    ...
    EXPECT_THAT(log_sink_->captured_log_, testing::HasSubstr("abseil_log_bridge_test2.c"));
