...
inline auto setScopedCommaLocale() -> android::base::ScopedCustomPtr<char, void (*)(const char*)> {
#ifdef _WIN32
    ...
    return android::base::makeCustomScopedPtr(oldLocaleCopy.release(), [](const char* name) {
