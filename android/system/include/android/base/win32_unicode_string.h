...
class Win32UnicodeString {
  ...
  public:
    ...
    explicit Win32UnicodeString(const std::wstring& str) : Win32UnicodeString(str.c_str()) {};
    ...
    static int convertToUtf8(char* outStr, int outLen, const wchar_t* str, int len = -1);
