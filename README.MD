...
The easiest way to start the emulator is to use the `launch_emulator` target. This target bundles a default system image and handles all the necessary setup.
