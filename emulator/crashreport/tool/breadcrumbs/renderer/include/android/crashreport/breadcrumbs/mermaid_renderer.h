...
/**
 * @brief Specialized renderer for Mermaid.js sequence diagrams.
 */
class MermaidRenderer : public TraceRenderer {
  public:
    /**
     * @brief Renders a structured trace into a Mermaid.js sequence diagram.
     *
     * @param trace The forensic model to render.
     * @return A string containing the Mermaid.js source.
     */
