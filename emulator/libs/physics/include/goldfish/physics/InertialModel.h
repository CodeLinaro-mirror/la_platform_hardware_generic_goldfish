...
class InertialModel {
 public:
   ...
   */
  glm::vec3 getPosition(ParameterValueType parameterValueType = ParameterValueType::CURRENT) const;
  glm::vec3 getVelocity(ParameterValueType parameterValueType = ParameterValueType::CURRENT) const;
  ...
  glm::quat getRotation(ParameterValueType parameterValueType = ParameterValueType::CURRENT) const;
   ...
   */
  float getAmbientMotion(ParameterValueType parameterValueType = ParameterValueType::CURRENT) const;
 ...
 private:
  ...
  void setInertialTransforms(const glm::vec3& hepticCoefficient, const glm::vec3& hexicCoefficient,
                             const glm::vec3& quinticCoefficient,
                             const glm::vec3& quarticCoefficient, const glm::vec3& cubicCoefficient,
                             const glm::vec3& quadraticCoefficient,
                             const glm::vec3& linearCoefficient,
                             const glm::vec3& constantCoefficient, const glm::vec4& hepticTimeVec,
