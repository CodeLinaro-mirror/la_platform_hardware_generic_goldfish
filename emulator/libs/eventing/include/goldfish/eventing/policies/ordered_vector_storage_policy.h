...
template <class T>
using WeakPtrOrderedVectorSource =
        EventSource<T, OrderedVectorStoragePolicy<T, std::weak_ptr<EventListener<T>>>>;

template <class T, class PointerType = EventListener<T>*>
using BlockingOrderedVectorSource =
        BlockingEventSource<T, OrderedVectorStoragePolicy<T, PointerType>>;
