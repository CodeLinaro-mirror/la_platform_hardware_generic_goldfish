...
template <class T>
using WeakPtrUnorderedSetSource =
        EventSource<T, UnorderedSetStoragePolicy<T, std::weak_ptr<EventListener<T>>>>;

template <class T, class PointerType = EventListener<T>*>
using BlockingUnorderedSetSource =
        BlockingEventSource<T, UnorderedSetStoragePolicy<T, PointerType>>;
