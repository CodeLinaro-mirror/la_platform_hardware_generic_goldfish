...
**Location:** `hardware/generic/goldfish/emulator/libs/ext4`
**Namespace:** `android::filesystems`

## Integration Guide
| Class / Interface | Bazel Target | Header Path | Description |
| :--- | :--- | :--- | :--- |
| `resizeExt4Partition` | `:ext4` | `include/android/filesystems/ext4_resize.h` | Resizes an existing ext4 partition file (invokes `resize2fs`). |
| `android_createEmptyExt4Image` | `:ext4` | `include/android/filesystems/ext4_utils.h` | Creates a new empty ext4 image (invokes `mkuserimg_mke2fs` or similar). |
...
* **System:** `//emulator/libs/system`, `//emulator/libs/process`, `//third_party/ext4_utils`.
