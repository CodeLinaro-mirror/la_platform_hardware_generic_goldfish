...
**Location:** `hardware/generic/goldfish/emulator/libs/grpc_security`
**Namespace:** `android::emulation::control`

## Integration Guide
| Class / Interface | Bazel Target | Header Path | Description |
| :--- | :--- | :--- | :--- |
| `AllowList` | `:grpc_security` | `include/android/emulation/control/allow_list.h` | Manages RPC method access rules (from JSON). |
| `JwtTokenAuth` | `:grpc_security` | `include/android/emulation/control/jwt_token_auth.h` | Verifies JWT tokens using JWKS. |
| `BasicTokenAuth` | `:grpc_security` | `include/android/emulation/control/basic_token_auth.h` | Simple shared-token authentication. |
...
## Dependencies
* **Core:** `//emulator/libs/grpc_utils:async`, `//emulator/libs/system`.
