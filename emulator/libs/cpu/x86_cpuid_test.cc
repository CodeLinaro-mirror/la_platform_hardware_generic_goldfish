...
TEST(x86_cpuid, android_get_x86_cpuid_vendor_id_type) {
    EXPECT_EQ(VENDOR_ID_AMD, android_get_x86_cpuid_vendor_id_type("AuthenticAMD"));
    EXPECT_EQ(VENDOR_ID_INTEL, android_get_x86_cpuid_vendor_id_type("GenuineIntel"));
    EXPECT_EQ(VENDOR_ID_VM, android_get_x86_cpuid_vendor_id_type("KVMKVMKVM"));
    EXPECT_EQ(VENDOR_ID_OTHER, android_get_x86_cpuid_vendor_id_type("any other string"));
}

TEST(x86_cpuid, android_get_x86_cpuid_vendor_vmhost_type) {
    EXPECT_EQ(VENDOR_VM_VMWARE, android_get_x86_cpuid_vendor_vmhost_type("VMWareVMWare"));
    EXPECT_EQ(VENDOR_VM_HYPERV, android_get_x86_cpuid_vendor_vmhost_type("Microsoft Hv"));
    EXPECT_EQ(VENDOR_VM_KVM, android_get_x86_cpuid_vendor_vmhost_type("KVMKVMKVM"));
    EXPECT_EQ(VENDOR_VM_VBOX, android_get_x86_cpuid_vendor_vmhost_type("VBoxVBoxVBox"));
