"""Creates a rule that runs CTS deqp sub."""

load("@rules_shell//shell:sh_test.bzl", "sh_test")

def deqp_tests(name, modules = []):
    """Creates a set of rules that runs CTS deqp sub.
    ...
    for m in modules:
        ...
        sh_test(
            ...
            env = {
                ...
                "TEST_SPEC": 'args: "-m" args: "CtsDeqpTestCases" args: "--module-arg" args: "CtsDeqpTestCases:include-filter:dEQP-VK.%s"' % m,
