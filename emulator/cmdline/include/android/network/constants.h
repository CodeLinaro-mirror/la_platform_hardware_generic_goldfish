...
// Describes one of the supported emulated network bandwidth limits.
...
extern bool android_network_speed_parse(const char* speed, double* upload_bauds,
                                        double* download_bauds);
...
extern bool android_network_latency_parse(const char* delay, double* min_delay_ms,
                                          double* max_delay_ms);
